...
class _RequestSpecificCardState extends State<RequestSpecificCard> {
  ...
  RxList<TextEditingController> familyNamesControllers =
  ...
  Future<void> _pickImage() async {
    final pickedFile =
        await _picker.pickImage(source: img_picker.ImageSource.gallery);
    if (pickedFile != null) {
      setState(() {
                  ...
                  child: GetBuilder<CardController>(
                    builder: (cardController) {
                      ...
                      final selectedCard = cardController.allCardList!
                          .firstWhereOrNull((card) =>
                              card.id == cardController.selectedCardId);
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          if (selectedCard != null) ...[
                            ...
                            Text(selectedCard.name ?? "No Name",
                            ...
                            Obx(() {
                                        ...
                                        validator: (value) {
                                          if (value == null || value.isEmpty) {
                                            ...
                                            setState(() {
                                              _hasError = true;
                                              _errorMessage =
                                                  "يجب أن يكون الرقم مكونًا من 10 أرقام"
                                                      .tr;
                                            });
                                            return '';
                                          }
                                                          ...
                                                          final cardRequest = RequestCardData(
                                                              ...
                                                              cardNumber: tokenController
                                                                  ...
                                                                  ? _cardNumberController
                                                                      .text
                                                                  : '',
                                                              familyMembersNames: familyNamesControllers
                                                                      .isNotEmpty
                              ...
                              return Column(
                                children: [
                                  ...
                                  Column(
                                    children: List.generate(
                                        familyNamesControllers.length, (index) {
                                      return Padding(
                                        padding: const EdgeInsets.symmetric(
                                            vertical: 5),
                                        child: TextFormField(
